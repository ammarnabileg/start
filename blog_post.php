...
?>
	...
	<section class="pt-10 bg-gray-100 sm:pt-16 lg:pt-24 pb-1">
		<div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
			<h2 class="text-right text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight"><?php echo $blog_posts_title; ?></h2>
			...
			<div class="lg:flex max-w-md gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full mb-16 lg:space-y-0 space-y-7">
				...
				<div class="lg:min-w-[300px] lg:max-w-[300px] space-y-7 ">
					...
					<div class="overflow-hidden rounded-3xl border border-solid border-black bg-white px-4 py-5 [box-:rgb(0,_0,_0)_9px_9px] ">
						<div class="py-5">
							...
							</p><p class="text-black text-xl font-semibold">الحجز والإستفسار
							</p>
							<p></p>
