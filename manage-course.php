...
<main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
 ...
 <!-- Course Info Card -->
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/10 p-6 mb-6">
 ...
 class="w-full px-4 py-3 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#2a2a2a] focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none dark:text-gray-200 "
 ...
 <button type="button" onclick="addSection()" class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">
