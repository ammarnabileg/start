  ...
  <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
    ...
    <form id="invite-form" class="p-6 space-y-4">
      <div>
        ...
        <input type="text" name="full_name" required class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500">
      </div>
      <div>
