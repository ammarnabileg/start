...
<main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 p-2 sticky top-20">
 <?php
 $nav_tabs = [
 ...
 <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all hover:-translate-y-0.5">Save Profile</button>
 </form>
 </div>
 ...
 <button type="submit" class="mt-5 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">Save Preferences</button>
 </form>
 </div>
 ...
 <div class="theme-card border-2 rounded-2xl overflow-hidden transition-all hover: <?= ($current_user['theme'] ?? 'light') === 'light' ? 'border-primary-500 shadow-primary-100' : 'border-gray-200 dark:border-white/10' ?>"
 ...
 <div class="theme-card border-2 rounded-2xl overflow-hidden transition-all hover: <?= ($current_user['theme'] ?? 'light') === 'dark' ? 'border-primary-500' : 'border-gray-200 dark:border-white/10' ?>"
