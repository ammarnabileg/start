  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        const SizedBox(height: 8),
        tile(Icons.emoji_events_outlined, 'الظهور في لوحات الصدارة',
            trailing: Switch(value: true, onChanged: (_) {})),
        tile(Icons.storefront_outlined, 'مشاركة بياناتي مع المتاجر',
            trailing: Switch(value: true, onChanged: (_) {})),
        const SizedBox(height: 12),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppCard(
                  child: Row(children: [
                    const AppIconBadge(Icons.visibility_rounded,
                        size: 44, iconSize: 22),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('مشاركة معلوماتي مع هذا المتجر',
                              style: Theme.of(context).textTheme.titleMedium),
                          const SizedBox(height: 2),
                          Text('هذا المتجر يستطيع رؤية ملفك والتواصل معك.',
                              style: Theme.of(context).textTheme.bodySmall),
                        ],
                      ),
                    ),
