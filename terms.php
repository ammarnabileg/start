...
<div class="max-w-3xl mx-auto px-4 py-16">
  <div class="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-10">
    <p class="text-amber-800 font-semibold text-sm leading-7">
      ...
      يُرجى قراءة هذه الشروط بعناية قبل استخدام المنصة. باستخدامك لـ PioneerIcons، فإنك توافق صراحةً على الالتزام بجميع ما يرد فيها.
    </p>
  </div>
  ...
  <div class="space-y-8" style="font-family:'Cairo',sans-serif;">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
      ...
      <div class="text-gray-600 text-sm leading-8">
        <p class="mb-3">PioneerIcons منصة رقمية مرجعية متخصصة في توثيق الشخصيات والمؤسسات العربية. نعمل وفق نموذج مفتوح يُتيح للعموم اقتراح الإضافات، مع خضوع كل اقتراح لمراجعة تحريرية دقيقة قبل النشر.</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
      ...
      <div class="text-gray-600 text-sm leading-8 space-y-3">
        <p>جميع عناصر المنصة — من تصميم وكود وهوية بصرية وعلامات تجارية — هي ملك حصري لـ PioneerIcons ومحمية قانونياً. لا يجوز نسخها أو تقليدها أو استخدامها دون إذن كتابي مسبق.</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
      ...
      <div class="text-gray-600 text-sm leading-8 space-y-3">
        <p>PioneerIcons مسؤولة عن دقة المحتوى الذي تُعدّه وتنشره بنفسها. أما المحتوى المقترح من المستخدمين، فيخضع للمراجعة ولكننا نعتمد على دقة ما يُقدَّم لنا.</p>
