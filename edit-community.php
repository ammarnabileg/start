...
<main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
 ...
 class="w-full px-4 py-3 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#2a2a2a] focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none dark:text-gray-200 "><?= e($community['description'] ?? '') ?></textarea>
 </div>
 <div>
