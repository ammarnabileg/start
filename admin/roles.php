...
$permission_groups = [
    ...
    'مستخدمو الموقع' => [
        56 => 'عرض المستخدمين',
        31 => 'إدارة المستخدمين (تعديل/حذف)',
    ],
    'طلبات الإعلان' => [
        57 => 'عرض الطلبات',
        32 => 'إدارة الطلبات (قبول/رفض)',
    ],
    'طلبات العضوية' => [
        58 => 'عرض الطلبات',
        33 => 'إدارة الطلبات (قبول/رفض)',
    ],
    'الشكاوي والملاحظات' => [
        59 => 'عرض الشكاوي',
        34 => 'إدارة الشكاوي (رد/حذف)',
    ],
    'مقترحات المستخدمين' => [
        60 => 'عرض المقترحات',
        35 => 'إدارة المقترحات (قبول/رفض)',
    ],
    'طلبات التعديل' => [
        61 => 'عرض الطلبات',
        36 => 'إدارة الطلبات (قبول/رفض)',
    ],
    'إعدادات النظام' => [
        30 => 'إعدادات الموقع',
    ],
