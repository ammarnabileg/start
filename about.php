    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
      <div>
        ...
        <p class="text-gray-600 text-base leading-8 mb-5">
          PioneerIcons هي المنصة المرجعية الأولى التي توثّق الشخصيات والمؤسسات العربية المؤثرة بمعايير عالمية. نحن لسنا مجرد دليل — نحن سجل موثّق لأصحاب القرار والريادة في العالم العربي.
        </p>
