    ...
    <div class="flex items-center gap-2 mt-2">
      ...
      <div class="flex-1 flex gap-2">
        ...
        <button onclick="submitComment(<?= $post['id'] ?>, <?= (int)$community_id ?>)"
                class="px-3 py-1.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-full text-xs font-semibold hover:shadow-md transition-all">Send</button>
      </div>
    </div>
  <?php endif; ?>
</div>
