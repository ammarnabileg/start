...
INSERT INTO `pi_settings` (`s_key`, `s_value`) VALUES
  ...
  ('footer_about',       'السجل العربي الموثق الذي يُقتبس منه في كل قرار يتعلق بشخصية أو مؤسسة مؤثرة. نوثق. نحمي. نُرجع.'),
  ('footer_col2_title',  ''),
  ('footer_col3_title',  'مواقع شقيقة'),
  ('footer_links',       ''),
  ('footer_sites',       ''),
  ('social_whatsapp',    ''),
  ('social_instagram',   ''),
...
INSERT INTO `pi_countries` (`c_id`, `c_name`, `c_flag`, `c_code`, `c_active`, `c_order`) VALUES
  ...
  (17, 'السودان',          '🇸🇩', 'sd', 1, 17),
  (18, 'فلسطين',           '🇵🇸', 'ps', 1, 18),
  (19, 'موريتانيا',        '🇲🇷', 'mr', 1, 19),
  (20, 'الصومال',          '🇸🇴', 'so', 1, 20),
  (21, 'جيبوتي',           '🇩🇯', 'dj', 1, 21),
  (22, 'جزر القمر',        '🇰🇲', 'km', 1, 22),
  (23, 'تركيا',            '🇹🇷', 'tr', 1, 30),
  (24, 'باكستان',          '🇵🇰', 'pk', 1, 31),
  (25, 'إيران',            '🇮🇷', 'ir', 1, 32),
  (26, 'أفغانستان',        '🇦🇫', 'af', 1, 33),
  (27, 'المملكة المتحدة',  '🇬🇧', 'gb', 1, 40),
  (28, 'الولايات المتحدة', '🇺🇸', 'us', 1, 41),
  (29, 'فرنسا',            '🇫🇷', 'fr', 1, 42),
  (30, 'ألمانيا',          '🇩🇪', 'de', 1, 43),
  (31, 'كندا',             '🇨🇦', 'ca', 1, 44),
  (32, 'أستراليا',         '🇦🇺', 'au', 1, 45)
ON DUPLICATE KEY UPDATE c_name=VALUES(c_name), c_flag=VALUES(c_flag);
...
--  37  manage_lists          38  add_sponsor         39  edit_sponsor       40  delete_sponsor
...
-- ─────────────────────────────────────────────────────────────
--  SAMPLE DATA — مستخدمون / شخصيات / مؤسسات / مقالات
--  كلمة مرور جميع المستخدمين: admin123
-- ─────────────────────────────────────────────────────────────

-- ── مستخدمو الموقع (5 مستخدمين) ─────────────────────────────
INSERT INTO `pi_users` (`u_id`,`u_name`,`u_email`,`u_password`,`u_phone`,`u_nationality`,`u_job`,`u_plan`,`u_active`,`u_verified`) VALUES
  (1,'أحمد ناصر',    'ahmed@example.com',  '$2y$12$JdbNysbQnXW3eIL6nz4ElupiPsv5HT83bd04FVBv2BLrKUUV/4mhu','0500000001','السعودية','مهندس برمجيات','free',1,1),
  (2,'سلمى خالد',   'salma@example.com',  '$2y$12$JdbNysbQnXW3eIL6nz4ElupiPsv5HT83bd04FVBv2BLrKUUV/4mhu','0500000002','مصر','مصممة جرافيك','free',1,1),
  (3,'يوسف العمري', 'yousef@example.com', '$2y$12$JdbNysbQnXW3eIL6nz4ElupiPsv5HT83bd04FVBv2BLrKUUV/4mhu','0500000003','الإمارات','مدير تسويق','verified',1,1),
  (4,'فاطمة الشمري','fatima@example.com', '$2y$12$JdbNysbQnXW3eIL6nz4ElupiPsv5HT83bd04FVBv2BLrKUUV/4mhu','0500000004','الكويت','طبيبة','free',1,1),
  (5,'طارق الأنصاري','tariq@example.com',  '$2y$12$JdbNysbQnXW3eIL6nz4ElupiPsv5HT83bd04FVBv2BLrKUUV/4mhu','0500000005','قطر','رجل أعمال','executive',1,1)
ON DUPLICATE KEY UPDATE u_name=VALUES(u_name);

-- ── شخصيات (10 شخصيات) ───────────────────────────────────────
INSERT INTO `pi_personalities`
  (`p_id`,`p_name_ar`,`p_name_en`,`p_title`,`p_nationality`,`p_residence`,`p_bio`,`p_verified`,`p_membership_type`,`p_country_id`,`p_views`,`p_active`)
VALUES
  (1,'محمد العبدالله','Mohammed Al-Abdullah','رائد أعمال ومستثمر','السعودية','السعودية','رائد أعمال سعودي بارز أسس أكثر من 12 شركة ناجحة في مجالات التقنية والتجارة الإلكترونية. يُعدّ من أبرز المستثمرين في منطقة الخليج، وشريك في عدة صناديق استثمارية تقنية. حاصل على درجة الماجستير في إدارة الأعمال من جامعة هارفارد.',1,'verified',1,4250,1),
  (2,'سارة الأحمد','Sara Al-Ahmad','خبيرة تقنية ورائدة في الذكاء الاصطناعي','الإمارات','الإمارات','مهندسة تقنية متخصصة في الذكاء الاصطناعي وتعلم الآلة. مؤسسة شركة NeuralArab لحلول الذكاء الاصطناعي. تحمل براءات اختراع في مجال معالجة اللغة العربية، وتُعدّ من أبرز الوجوه النسائية في قطاع التقنية العربي.',1,'executive',3,6870,1),
  (3,'خالد المنصور','Khalid Al-Mansour','صحفي وكاتب','الكويت','الكويت','صحفي ومذيع كويتي بارز بخبرة تجاوزت 20 عاماً في الإعلام العربي. رئيس تحرير سابق لعدة صحف ومجلات خليجية، ويُشارك حالياً في برامج تلفزيونية متخصصة في الشأن الاقتصادي والسياسي.',0,'standard',4,2100,1),
  (4,'نور الحسن','Nour Al-Hassan','طبيبة واختصاصية أورام','مصر','مصر','طبيبة مصرية متخصصة في أورام الثدي وحاصلة على زمالة من كلية الملوك الملكية بلندن. أسّست أول عيادة متخصصة في الكشف المبكر عن السرطان في مصر، ونشرت أبحاثاً في مجلات طبية دولية محكّمة.',1,'verified',2,3450,1),
  (5,'عمر الراشد','Omar Al-Rashed','مهندس معماري','قطر','قطر','مهندس معماري قطري حاصل على جائزة آغا خان للعمارة عام 2022. صمّم أبرز المشاريع المعمارية في الدوحة، ويُدرّس حالياً في كلية العمارة بجامعة قطر.',0,'standard',7,1780,1),
  (6,'ليلى الزهراني','Layla Al-Zahrani','روائية وكاتبة','السعودية','السعودية','روائية سعودية صدرت لها سبعة روايات ترجمت إلى أكثر من 12 لغة. فازت بجائزة البوكر العربية عام 2021 عن روايتها "بين المدّ والجزر". عضو في الاتحاد الدولي للكتّاب.',1,'verified',1,5120,1),
  (7,'أحمد الدوسري','Ahmed Al-Dosari','لاعب كرة قدم دولي','البحرين','البحرين','لاعب كرة قدم بحريني يُعدّ من أبرز المواهب الخليجية. لعب في أندية أوروبية بارزة، وكان قائداً للمنتخب الوطني البحريني في عدة بطولات دولية.',0,'standard',5,8340,1),
  (8,'مريم العامري','Mariam Al-Ameri','أستاذة جامعية وباحثة','الإمارات','الإمارات','أستاذة في كلية الهندسة بجامعة الإمارات العربية المتحدة، متخصصة في الطاقة المتجددة. تقود فريقاً بحثياً حول حلول الطاقة الشمسية في المناطق الحارة.',1,'verified',3,2670,1),
  (9,'فيصل التميمي','Faisal Al-Tamimi','اقتصادي ومستشار مالي','السعودية','السعودية','اقتصادي سعودي مرموق شغل منصب مستشار اقتصادي في عدة حكومات خليجية. حاصل على دكتوراه في الاقتصاد من جامعة لندن، ومؤلف عدة كتب في الاقتصاد العربي.',0,'standard',1,1950,1),
  (10,'دينا الخطيب','Dina Al-Khatib','ناشطة حقوقية ومحامية','الأردن','الأردن','محامية أردنية ومؤسسة منظمة "حقوق بلا حدود" لحقوق الإنسان. فازت بجائزة المرأة العربية الأكثر تأثيراً لعام 2023، وتعمل على قضايا اللاجئين وحقوق الطفل.',1,'verified',10,4800,1)
ON DUPLICATE KEY UPDATE p_name_ar=VALUES(p_name_ar);

-- ── تصنيف الشخصيات ────────────────────────────────────────────
INSERT INTO `pi_personality_categories` (`p_id`,`cat_id`) VALUES
  (1,1),(1,12),(2,4),(2,9),(3,5),(4,6),(5,11),(6,10),(7,7),(8,2),(8,9),(9,12),(10,8)
ON DUPLICATE KEY UPDATE p_id=VALUES(p_id);

-- ── مؤسسات (6 مؤسسات) ───────────────────────────────────────
INSERT INTO `pi_institutions`
  (`inst_id`,`inst_name_ar`,`inst_name_en`,`inst_description`,`inst_country_id`,`inst_verified`,`inst_membership_type`,`inst_views`,`inst_active`,`inst_country`)
VALUES
  (1,'شركة التقنيات العربية','Arab Technologies Co.','شركة رائدة في تطوير حلول البرمجيات والذكاء الاصطناعي للسوق العربي. تأسست عام 2015 وتضم أكثر من 500 موظف في 8 دول عربية. توفر منصات تقنية لأكثر من 200 مؤسسة حكومية وخاصة.',3,1,'verified',3200,1,'الإمارات'),
  (2,'مركز الإعلام الرقمي','Digital Media Center','مركز إعلامي متخصص في الإنتاج الرقمي والمحتوى العربي. يضم فريقاً من أكثر من 120 صحفياً ومبدعاً رقمياً، وينتج محتوى يصل إلى ملايين المشاهدين يومياً عبر المنصات الرقمية.',4,0,'standard',1450,1,'الكويت'),
  (3,'مستشفى الرعاية الحديثة','Modern Care Hospital','مستشفى من الدرجة الأولى يتخصص في جراحات القلب والأورام. يستقطب أطباء من 20 جنسية مختلفة، ويُعالج سنوياً أكثر من 50,000 حالة بمستوى عالمي الجودة.',2,1,'executive',2780,1,'مصر'),
  (4,'مؤسسة الريادة والابتكار','Entrepreneurship & Innovation Foundation','مؤسسة غير ربحية تهتم بدعم رواد الأعمال الشباب في العالم العربي. تقدم برامج تدريبية ومنحاً لأكثر من 1000 رائد أعمال سنوياً، وأسهمت في إطلاق أكثر من 300 شركة ناشئة.',1,1,'verified',4100,1,'السعودية'),
  (5,'جامعة العلوم التطبيقية','University of Applied Sciences','جامعة قطرية تأسست عام 2008 وتُصنَّف ضمن أفضل 100 جامعة عربية. تضم 15 كلية و8000 طالب من 60 جنسية مختلفة، وتتميز بمختبراتها البحثية المتطورة.',7,1,'verified',2350,1,'قطر'),
  (6,'صندوق الاستثمار الخليجي','Gulf Investment Fund','صندوق استثماري متخصص في التكنولوجيا والعقارات والطاقة المتجددة. يدير أصولاً تجاوزت 4 مليارات دولار، ويستثمر في أكثر من 60 شركة في 12 دولة.',1,0,'standard',1870,1,'السعودية')
ON DUPLICATE KEY UPDATE inst_name_ar=VALUES(inst_name_ar);

-- ── تصنيف المؤسسات ────────────────────────────────────────────
INSERT INTO `pi_institution_categories` (`inst_id`,`cat_id`) VALUES
  (1,4),(2,5),(3,6),(4,1),(5,2),(6,12)
ON DUPLICATE KEY UPDATE inst_id=VALUES(inst_id);

-- ── روابط التواصل الاجتماعي ────────────────────────────────────
INSERT INTO `pi_social_links` (`sl_entity_type`,`sl_entity_id`,`sl_platform`,`sl_url`) VALUES
  ('personality',1,'linkedin','https://linkedin.com/in/mohammed-alabdullah'),
  ('personality',1,'twitter','https://twitter.com/mabdullah'),
  ('personality',2,'linkedin','https://linkedin.com/in/sara-alahmad'),
  ('personality',2,'instagram','https://instagram.com/sara.alahmad'),
  ('personality',4,'linkedin','https://linkedin.com/in/nour-alhassan'),
  ('personality',6,'twitter','https://twitter.com/layla_zahrani'),
  ('personality',7,'instagram','https://instagram.com/ahmed.aldosari'),
  ('personality',8,'linkedin','https://linkedin.com/in/mariam-alameri'),
  ('institution',1,'linkedin','https://linkedin.com/company/arab-tech'),
  ('institution',4,'twitter','https://twitter.com/riadah_fund');

-- ── التسلسل الزمني للشخصيات ───────────────────────────────────
INSERT INTO `pi_timeline` (`tl_p_id`,`tl_type`,`tl_title`,`tl_institution`,`tl_year_start`,`tl_year_end`,`tl_order`) VALUES
  (1,'education','ماجستير إدارة الأعمال','جامعة هارفارد','2005','2007',1),
  (1,'work','المدير التنفيذي','شركة نما للاستثمار','2008','2015',2),
  (1,'work','مؤسس ورئيس','مجموعة العبدالله القابضة','2015','حتى الآن',3),
  (2,'education','بكالوريوس هندسة الحاسب','جامعة الإمارات','2010','2014',1),
  (2,'education','دكتوراه في الذكاء الاصطناعي','جامعة كارنيجي ميلون','2014','2018',2),
  (2,'work','مؤسسة ورئيسة تنفيذية','NeuralArab','2018','حتى الآن',3),
  (4,'education','بكالوريوس الطب والجراحة','جامعة القاهرة','2000','2006',1),
  (4,'education','زمالة أمراض الأورام','كلية الملوك الملكية - لندن','2008','2011',2),
  (4,'work','استشارية أورام','مستشفى الرعاية الحديثة','2012','حتى الآن',3),
  (6,'work','كاتبة مستقلة','','2010','2015',1),
  (6,'work','روائية وعضو المجلس الثقافي','وزارة الثقافة السعودية','2016','حتى الآن',2);

-- ── مقالات (8 مقالات) ────────────────────────────────────────
INSERT INTO `pi_articles` (`art_p_id`,`art_title`,`art_body`,`art_source`,`art_url`,`art_active`) VALUES
  (1,'محمد العبدالله يطلق صندوق استثمار تقني بقيمة 500 مليون ريال','<p>أعلن رجل الأعمال السعودي محمد العبدالله عن إطلاق صندوق استثماري جديد يستهدف الشركات التقنية الناشئة في المنطقة العربية بقيمة إجمالية تبلغ 500 مليون ريال سعودي. وأوضح العبدالله أن الصندوق سيركز على ثلاثة قطاعات رئيسية: الذكاء الاصطناعي، والتجارة الإلكترونية، والتقنية المالية.</p>','فوربس عربية','#',1),
  (1,'العبدالله ضمن قائمة أقوى 50 رجل أعمال عربياً لعام 2025','<p>احتلّ رائد الأعمال السعودي محمد العبدالله المرتبة الثانية عشرة في قائمة أقوى 50 رجل أعمال عربياً التي أصدرتها مجلة فوربس الشرق الأوسط لعام 2025. وجاء هذا التصنيف نتيجة نجاح شركاته في توسيع أعمالها إلى 8 دول جديدة خلال العام الماضي.</p>','فوربس الشرق الأوسط','#',1),
  (2,'سارة الأحمد تحصل على جائزة أفضل مبتكرة عربية في الذكاء الاصطناعي','<p>حصلت الدكتورة سارة الأحمد على جائزة أفضل مبتكرة عربية في مجال الذكاء الاصطناعي خلال مؤتمر GITEX العالمي 2025. وقالت الأحمد إن التقنية التي طورتها تُمكّن أنظمة الذكاء الاصطناعي من فهم اللهجات العربية المختلفة بدقة تصل إلى 97%.</p>','تك كرانش عربي','#',1),
  (4,'د. نور الحسن تفتتح أول مركز متخصص للكشف المبكر عن سرطان الثدي','<p>افتتحت الدكتورة نور الحسن أول مركز متخصص في الكشف المبكر عن سرطان الثدي باستخدام تقنيات الذكاء الاصطناعي في مصر. يُعدّ المركز الأول من نوعه في منطقة شمال أفريقيا، ويستخدم تقنية التصوير الطيفي المتقدم لاكتشاف الأورام في مراحلها الأولى.</p>','الأهرام الطبي','#',1),
  (6,'ليلى الزهراني تفوز بجائزة البوكر العربية عن روايتها الجديدة','<p>فازت الروائية السعودية ليلى الزهراني بالجائزة العالمية للرواية العربية (البوكر) عن روايتها الجديدة "بين المدّ والجزر". وأشاد أعضاء لجنة التحكيم بالأسلوب السردي الفريد للرواية وبمعالجتها العميقة للهوية والانتماء في العالم العربي المعاصر.</p>','الجزيرة الثقافية','#',1),
  (7,'أحمد الدوسري يقود البحرين إلى نهائيات كأس الخليج','<p>قاد النجم البحريني أحمد الدوسري منتخب بلاده إلى نهائيات كأس الخليج للمرة الأولى في تاريخه بعد أداء مبهر خلال الدور التمهيدي. سجّل الدوسري ثلاثية في مباراة الحسم ضد منتخب الإمارات وأصبح الهداف التاريخي للمنتخب البحريني.</p>','سبورت ستار العرب','#',1),
  (8,'د. مريم العامري تحصل على منحة بحثية من ناسا لدراسة الطاقة الشمسية','<p>حصلت الدكتورة مريم العامري من جامعة الإمارات على منحة بحثية مشتركة مع وكالة ناسا الأمريكية لدراسة كفاءة الألواح الشمسية في درجات الحرارة المرتفعة. يُمثّل هذا التعاون نموذجاً استثنائياً للشراكة البحثية بين مؤسسات عربية وأمريكية في مجال الطاقة المتجددة.</p>','العلوم والتقنية','#',1),
  (9,'فيصل التميمي يُصدر تقريراً حول مستقبل الاقتصاد الخليجي 2030','<p>أصدر الدكتور فيصل التميمي تقريراً اقتصادياً شاملاً بعنوان "الخليج 2030: رؤية اقتصادية جديدة" يرصد فيه التحولات الاقتصادية المتوقعة في المنطقة خلال العقد القادم. ويُحذّر التقرير من مخاطر الاعتماد على النفط ويقدم 15 توصية لتنويع الاقتصاد.</p>','اقتصاد الشرق','#',1)
ON DUPLICATE KEY UPDATE art_title=VALUES(art_title);

-- ── رعاة (2 رعاة تجريبيان) ────────────────────────────────────
INSERT INTO `pi_sponsors` (`sp_id`,`sp_name`,`sp_logo`,`sp_url`,`sp_active`,`sp_order`,`sp_views`) VALUES
  (1,'شركة التقنيات العربية','','https://example.com',1,1,120),
  (2,'صندوق الريادة','','https://example.com',1,2,85)
ON DUPLICATE KEY UPDATE sp_name=VALUES(sp_name);

-- ─────────────────────────────────────────────────────────────
SET FOREIGN_KEY_CHECKS = 1;

/*
  ✅ PioneerIcons v4.0 — Installation complete!
  ...
  To export live data from production server, visit:
  /admin.php?p=export_sql  (while logged in as admin)

  Changes in v4.1:
  - Added art_body + art_image_upload columns to pi_articles
  - Added 5 sample users (password: admin123)
  - Added 10 sample personalities
  - Added 6 sample institutions
  - Added 8 sample articles
  - Added social links, timelines, categories assignments
  - Added 2 sample sponsors

  Changes in v4.0:
  - sp_views column added to pi_sponsors
  - inst_membership_type added to pi_institutions
  - er_req_type / er_notes / er_upgrade_to added to pi_edit_requests
  - hero_pill, footer_col2_title, footer_col3_title, footer_links, footer_sites settings added
  - All 11 social platforms added to settings (whatsapp, instagram, facebook, twitter, linkedin, youtube, tiktok, snapchat, telegram, threads, pinterest)
  - 32 countries seeded (22 Arab + 10 international)
*/
