...
INSERT INTO `pi_personalities`
  (`p_id`,`p_name_ar`,`p_name_en`,`p_title`,`p_nationality`,`p_residence`,`p_bio`,`p_website`,`p_verified`,`p_membership_type`,`p_country_id`,`p_views`,`p_active`)
VALUES
  (1,'محمد العبدالله','Mohammed Al-Abdullah','رائد أعمال ومستثمر','السعودية','السعودية','رائد أعمال سعودي بارز أسس أكثر من 12 شركة ناجحة في مجالات التقنية والتجارة الإلكترونية.','',1,'verified',1,4250,1),
  (2,'سارة الأحمد','Sara Al-Ahmad','خبيرة تقنية ورائدة في الذكاء الاصطناعي','الإمارات','الإمارات','مهندسة تقنية متخصصة في الذكاء الاصطناعي وتعلم الآلة. مؤسسة شركة NeuralArab لحلول الذكاء الاصطناعي.','https://neuralarab.com',1,'executive',3,6870,1),
  (3,'خالد المنصور','Khalid Al-Mansour','صحفي وكاتب','الكويت','الكويت','صحفي ومذيع كويتي بارز بخبرة تجاوزت 20 عاماً في الإعلام العربي.','',0,'standard',4,2100,1),
  (4,'نور الحسن','Nour Al-Hassan','طبيبة واختصاصية أورام','مصر','مصر','طبيبة مصرية متخصصة في أورام الثدي وحاصلة على زمالة من كلية الملوك الملكية بلندن.','',1,'verified',2,3450,1),
  (5,'عمر الراشد','Omar Al-Rashed','مهندس معماري','قطر','قطر','مهندس معماري قطري حاصل على جائزة آغا خان للعمارة عام 2022.','',0,'standard',7,1780,1),
  (6,'ليلى الزهراني','Layla Al-Zahrani','روائية وكاتبة','السعودية','السعودية','روائية سعودية صدرت لها سبعة روايات ترجمت إلى أكثر من 12 لغة. فازت بجائزة البوكر العربية عام 2021.','',1,'verified',1,5120,1),
  (7,'أحمد الدوسري','Ahmed Al-Dosari','لاعب كرة قدم دولي','البحرين','البحرين','لاعب كرة قدم بحريني يُعدّ من أبرز المواهب الخليجية. لعب في أندية أوروبية بارزة.','',0,'standard',5,8340,1),
  (8,'مريم العامري','Mariam Al-Ameri','أستاذة جامعية وباحثة','الإمارات','الإمارات','أستاذة في كلية الهندسة بجامعة الإمارات، متخصصة في الطاقة المتجددة.','',1,'verified',3,2670,1),
  (9,'فيصل التميمي','Faisal Al-Tamimi','اقتصادي ومستشار مالي','السعودية','السعودية','اقتصادي سعودي مرموق شغل منصب مستشار اقتصادي في عدة حكومات خليجية.','',0,'standard',1,1950,1),
  (10,'دينا الخطيب','Dina Al-Khatib','ناشطة حقوقية ومحامية','الأردن','الأردن','محامية أردنية ومؤسسة منظمة "حقوق بلا حدود" لحقوق الإنسان.','',1,'verified',10,4800,1)
