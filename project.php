...
$project_id_from_url= $_GET['id'];
$result = $mysqli->query("SELECT * FROM projects where projects_id=$project_id_from_url") or die($$mysqli->error);
$x=0;
...
<section>
	...
	<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
		<!-- Title -->
<?php if (isset($projects_logo)){ ?>
		<img src="uploads/img/<?php echo $projects_logo; ?>" class="max-w-[50%] mx-auto my-[30px]">
<?php } ?>
<?php if (isset($projects_name)){ ?>
		<h2 class="text-center text-3xl font-bold md:text-5xl"> <?php echo $projects_name; ?> </h2>
<?php } ?>
<?php if (isset($projects_txt1)){ ?>
		<p class="mb-8 mt-4 text-center text-sm text-gray-500 sm:text-base md:mb-12 lg:mb-16"> <?php echo $projects_txt1; ?> </p>
<?php } ?>


<?php if (isset($projects_thumbnail)){ ?>
		<!-- Content -->
		<div class="grid justify-items-stretch md:mb-12 md:grid-cols-3 md:gap-4 lg:mb-16 lg:gap-6">
			<a class="relative flex h-[500px] flex-col gap-4 rounded-md px-4 py-8 [grid-area:1/1/2/2] md:p-0 md:[grid-area:1/1/2/4]">
				<img src="uploads/img/<?php echo $projects_thumbnail; ?>" class="inline-block h-full w-full object-cover" />
			</a>
		</div>
...
<?php if (isset($projects_video1)){ ?>

<iframe height="400" class="w-full" src="https://www.youtube.com/embed/<?php echo $projects_video1; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<?php } ?>
...
<section class=" bg-gray-50 ">
	...
	<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
		<!-- Component -->
		<div class=" bg-[url('assets/img/white-bg.webp')] bg-[#fff] rounded p-8 text-center sm:p-10 md:p-16">
			<div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
				<p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">تسجيل إستشارة مجانية</p>
	...
	<div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
		<div class="grid items-center grid-cols-1 lg:items-stretch md:grid-cols-2 gap-y-8 gap-x-12 xl:gap-x-20">
					...
					<div class="w-full">
						<div id="default-carousel" class="relative" data-carousel="static">
							...
							<div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
								<?php							
								$result = $mysqli->query("SELECT * FROM projects_photos where projects_photos_project_id=$project_id_from_url") or die($$mysqli->error);
								while ($row = $result->fetch_assoc()){
								?>
								<!-- Item -->
								<div class="hidden duration-700 ease-in-out" data-carousel-item>
									<img id="myImg<?php echo $row["projects_photos_id"]; ?>" src="uploads/img/<?php echo $row["projects_photos_img"]; ?>" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="<?php echo $projects_name; ?>">
								</div>
								<?php
								}
								?>
			...
			<div class="flex flex-col justify-between ">
				<blockquote>
					<div class="text-2xl leading-relaxed text-[#000]"> <?php echo $projects_txt2; ?> </div>
				</blockquote>
...
<section class="bg-[#f3f4f6]">
	...
	<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
		<!-- Component -->
		<div class="bg-[#fff] rounded p-8 text-center sm:p-10 md:p-16">
...
<section class=" bg-gray-100 ">
	<div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
		...
		<iframe height="400" class="w-full mb-10" src="https://www.youtube.com/embed/<?php echo $projects_video2; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>



		<div class="items-center grid-cols-1 lg:items-stretch md:grid-cols-2 gap-y-8 gap-x-12 xl:gap-x-20">

			<div class="flex flex-col justify-between ">
				<blockquote class="text-2xl leading-relaxed text-black">
					<?php echo $projects_txt3; ?>
				</blockquote>
