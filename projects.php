...
<section class="pt-10 bg-gray-50 sm:pt-16 lg:pt-24" >
	<div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
		...
		<div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full mb-16">
			...
			<div class="relative overflow-hidden rounded-3xl border border-solid border-black bg-white  [box-shadow:rgb(0,_0,_0)_9px_9px]  ">
			<?php 
		...
		<div class="flex justify-center">
			<div class=" inline-flex justify-center gap-2">
				...
				if($pagenum>1){ ?>
				<a href="projects.php?page=<?php echo ($pagenum-1); ?>" class="inline-flex size-8 items-center justify-center rounded overflow-hidden border border-solid border-black bg-white text-gray-900 px-3 py-4 [box-shadow:rgb(0,_0,_0)_3px_3px]">
				...
				if($pagenum>1){ ?>
				<a href="projects.php?page=<?php echo ($pagenum-1); ?>" class="inline-flex size-8 items-center justify-center rounded overflow-hidden border border-solid border-black bg-white text-gray-900 px-3 py-4 [box-shadow:rgb(0,_0,_0)_3px_3px]"><?php echo ($pagenum-1); ?></a>
				<?php   } ?>
