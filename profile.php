...
<main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center ">
 ...
 class="group bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden hover: hover:border-gray-300 dark:hover:border-white/20 transition-all">
 ...
 <div class="p-4 -mt-5">
 <?php if ($c['logo']): ?>
 <img src="<?= e($c['logo']) ?>" class="w-10 h-10 rounded-xl border-2 border-white dark:border-[#1a1a1a] object-cover mb-2">
 <?php else: ?>
 <div class="w-10 h-10 rounded-xl border-2 border-white dark:border-[#1a1a1a] bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white font-black mb-2"><?= strtoupper(substr($c['name'],0,1)) ?></div>
 <?php endif; ?>
 ...
 <a href="/community.php?slug=<?= e($c['slug']) ?>"
 class="group bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 p-4 hover: hover:border-gray-300 dark:hover:border-white/20 transition-all flex items-center gap-3">
 <?php if ($c['logo']): ?>
 ...
 <!-- Quick Stats -->
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 p-5 ">
