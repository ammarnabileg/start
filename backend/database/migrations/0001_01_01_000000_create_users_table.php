...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('tenants', function (Blueprint $table) {
            ...
            $table->string('career_page_title')->nullable();
            $table->text('career_page_description')->nullable();
            $table->string('career_page_logo')->nullable();
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('user_type')->default('hr');
