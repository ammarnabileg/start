...
if (!$course_is_member) {
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-3xl border border-gray-100 dark:border-white/10 p-12">
 ...
 class="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl font-bold hover: transition-all hover:-translate-y-0.5">
 Join Community
 </a>
 <?php else: ?>
 <a href="/login.php" class="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl font-bold hover: transition-all hover:-translate-y-0.5">Sign In to Join</a>
 <?php endif; ?>
 </div>
 </main>
 <?php
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
 ...
 <!-- Progress bar -->
 <div class="bg-white dark:bg-[#1a1a1a] rounded-xl p-4 mb-4 border border-gray-100 dark:border-white/10 ">
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/10 overflow-hidden ">
 <!-- Video or Content -->
 ...
 <?php else: ?>
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-white/10 p-12 text-center ">
...
<div id="completion-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
 <div class="bg-white dark:bg-[#1a1a1a] rounded-3xl w-full max-w-md p-8 text-center">
 ...
 class="px-5 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">
 Continue Learning
 </button>
 </div>
 </div>
