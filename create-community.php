...
<main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-3xl border border-gray-100 dark:border-white/10 overflow-hidden">
 <!-- Step Indicator -->
 ...
 <button type="button" onclick="goToStep(2)" class="px-6 py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl font-semibold hover: transition-all hover:-translate-y-0.5">Next: Media →</button>
 </div>
 </div>
 ...
 <button type="button" onclick="goToStep(3)" class="px-6 py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl font-semibold hover: transition-all hover:-translate-y-0.5">Next: Pricing →</button>
 </div>
 </div>
 ...
 <button type="button" onclick="goToStep(4)" class="px-6 py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl font-semibold hover: transition-all hover:-translate-y-0.5">Next: Links →</button>
 </div>
 </div>
