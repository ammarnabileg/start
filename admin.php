...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
 ...
 <div class="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/10 p-3 sticky top-20">
 ...
 <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">Save Settings</button>
 </form>
 </div>
 ...
 <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">Save SEO Settings</button>
 </form>
 </div>
 ...
 <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-primary-600 to-accent-500 text-white rounded-xl text-sm font-semibold hover: transition-all">Save Pricing</button>
 </form>
 </div>
