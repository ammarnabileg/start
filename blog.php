	...
	<div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
		...
		<div class="flex justify-center">
			<div class=" inline-flex justify-center gap-2">
				...
				if($pagenum>1){ ?>
				<a href="blog.php?page=<?php echo ($pagenum-1); ?>" class="inline-flex size-8 items-center justify-center rounded overflow-hidden border border-solid border-black bg-white text-gray-900 px-3 py-4 [box-shadow:rgb(0,_0,_0)_3px_3px]">
				...
				if($pagenum>1){ ?>
				<a href="blog.php?page=<?php echo ($pagenum-1); ?>" class="inline-flex size-8 items-center justify-center rounded overflow-hidden border border-solid border-black bg-white text-gray-900 px-3 py-4 [box-shadow:rgb(0,_0,_0)_3px_3px]"><?php echo ($pagenum-1); ?></a>
				<?php   } ?>
